...
import { customModel, imageGenerationModel } from '@/components/lib/ai';
import { models } from '@/components/lib/ai/models';
import {
  codePrompt,
  systemPrompt,
  updateDocumentPrompt,
} from '@/components/lib/ai/prompts';
import {
  deleteChatById,
  getChatById,
  getDocumentById,
  ...
  saveMessages,
  saveSuggestions,
} from '@/components/lib/db/queries';
import type { Suggestion } from '@/components/lib/db/schema';
import {
  generateUUID,
